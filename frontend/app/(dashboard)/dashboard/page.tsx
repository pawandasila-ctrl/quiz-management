...
export const metadata: Metadata = {
  ...
  description:
    "Browse published quizzes, take assessments, and review results.",
};
...
export default async function StudentDashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in duration-300">
      {/* Hero Banner using Shadcn Card */}
      <Card className="relative overflow-hidden rounded-3xl border-primary/20 bg-linear-to-r from-indigo-950 via-slate-900 to-slate-950 text-white shadow-xl">
        ...
        <CardContent className="relative z-10 px-6 py-4 sm:px-8 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-2 max-w-xl">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Explore available assessments, review detailed breakdown results,
              and challenge yourself on the global leaderboard.
            </p>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-3">
            <Link href="/dashboard/my-quizzes">
              <Button
                size="default"
                className="font-semibold bg-linear-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 text-white shadow-lg shadow-indigo-500/25 h-10 px-5 text-xs sm:text-sm"
              >
                View My History
              </Button>
            </Link>
