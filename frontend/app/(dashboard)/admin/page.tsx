...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in duration-300">
      {/* Admin Hero Header */}
      <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-950 p-6 sm:p-8 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-2 max-w-xl">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Design new quizzes, manage question banks, review student submissions, and publish leaderboard scores.
            </p>
          </div>
